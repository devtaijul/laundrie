      ...
      <div className="max-w-md mx-auto px-6 py-8">
        ...
        <div className="bg-muted/50 border border-border rounded-lg p-4 mb-8">
          <p className="text-sm text-muted-foreground">
            We're finding you the perfect Laundry Pro based on your preferences.
            This usually happens within 60 minutes.
          </p>
        </div>
        ...
        <div className="flex gap-4">
          <Button
            variant="outline"
            onClick={() => navigate.push(`/order-details/${orderData.orderId}`)}
            className="flex-1"
          >
            MORE DETAILS
          </Button>
          <Button
            onClick={() => navigate.push("/order-flow")}
